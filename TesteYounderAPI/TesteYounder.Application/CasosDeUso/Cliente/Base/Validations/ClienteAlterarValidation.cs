...
{
    public class ClienteAlterarValidation : AbstractValidator<AlterarClienteRequest>
    {
        public ClienteAlterarValidation()
        {
            ValidateNomeNulo();
            ValidateNomeTamanho();
            ValidateCpfNulo();
        ...
        protected void ValidateIdNulo()
        {
            RuleFor(r => r.Id)
                .NotNull()
                .WithMessage("O ID do cliente é obrigatório para a alteração!");
        }
